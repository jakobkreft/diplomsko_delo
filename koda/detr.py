# -*- coding: utf-8 -*-
"""Jakob_detr_demo.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1seAV6aR6YTaMF8vDkiVRKDsOFhBIbZBJ
...
def plot_results(pil_img, prob, boxes):
    ...
    #plt.imshow(pil_img)
    ax = plt.gca()
    with open("/content/drive/MyDrive/diplomska_slike/t6A_boundingbox.csv", 'a') as csvfile:
        fieldnames = ['image', 'class', 'prob', 'xmin', 'ymin', 'xmax', 'ymax']
    ...
    for p, (xmin, ymin, xmax, ymax), c in zip(prob, boxes.tolist(), COLORS * 100):
        ...
        with open("/content/drive/MyDrive/diplomska_slike/t6A_boundingbox.csv", 'a') as csvfile:
            fieldnames = ['image', 'class', 'prob', 'xmin', 'ymin', 'xmax', 'ymax']
            writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
            writer.writerow({'image': imgname, 'class': CLASSES[cl], 'prob': f'{p[cl]:0.4f}', 'xmin': xmin, 'ymin': ymin, 'xmax': xmax, 'ymax': ymax})
            print(CLASSES[cl],p[cl])
    #plt.axis('off')
    #plt.show()


for x in range(1, 7509):
    imgname = "frameC" + str(x)
    im = Image.open("/content/drive/MyDrive/diplomska_slike/t6A/"+ imgname + ".jpg")
    scores, boxes = detect(im, detr, transform)
    plot_results(im, scores, boxes)
    print("done frameC"+ str(x))